...
class TestParserFunctional:
    ...
    def test_parse_real_stats(self, test_data_path):
        ...
        with tempfile.TemporaryDirectory() as output_dir:
            ...
            with patch('src.data_parser.src.configurationManager.ConfigurationManager.getParser') as mock_get_parser, \
                 patch('src.data_parser.src.configurationManager.ConfigurationManager.getCompress') as mock_get_compress:
            ...
            # Check content
            df = pd.read_csv(expected_csv, sep=r'\s+')
