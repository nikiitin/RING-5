...
@pytest.fixture
def mock_streamlit():
    with patch("src.web.ui.data_managers.mixer.st") as mock_st_mixer, \
         patch("src.web.ui.data_managers.preprocessor.st") as mock_st_prep:
...
def test_mixer_render_numeric_op(mock_streamlit, sample_data):
    ...
    with patch("src.web.services.data_processing_service.DataProcessingService.apply_mixer") as mock_apply:
...
def test_preprocessor_render_op(mock_streamlit, sample_data):
    ...
    with patch("src.web.services.data_processing_service.DataProcessingService.apply_operation") as mock_op:
        with patch("src.web.services.data_processing_service.DataProcessingService.list_operators") as mock_list:
