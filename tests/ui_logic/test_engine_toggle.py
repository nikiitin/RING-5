"""Tests for engine selector rendering in ChartDisplayComponent.

Verifies that ``ChartDisplayComponent.render_engine_selector()`` correctly
...
_PRESENTER = "src.web.components.common.chart_display"


class TestEngineSelector:
    """ChartDisplayComponent.render_engine_selector rendering and return value."""
    ...
    def test_pills_called_with_correct_args(self, mock_st: MagicMock) -> None:
        ...
        ChartDisplayComponent.render_engine_selector(plot_id=5, current_engine="plotly")
    ...
    def test_returns_selected_engine(self, mock_st: MagicMock) -> None:
        ...
        result: Optional[str] = ChartDisplayComponent.render_engine_selector(
    ...
    def test_widget_key_includes_plot_id(self, mock_st: MagicMock) -> None:
        ...
        mock_st.pills.return_value = "plotly"
        ChartDisplayComponent.render_engine_selector(plot_id=42, current_engine="plotly")
