...
class DummyPlot(BasePlot):
    def render_config_ui(self, data, saved_config): return {}
    def create_figure(self, data, config): return None
    def get_legend_column(self, config): return None

def test_render_create_plot_section(mock_streamlit, mock_plot_service, mock_state_manager, mock_plot_factory):
