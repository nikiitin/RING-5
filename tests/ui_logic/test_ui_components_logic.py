...
@pytest.fixture
def mock_streamlit():
    with patch("src.web.ui.components.data_source_components.st") as mock_st_ds, \
         patch("src.web.ui.components.upload_components.st") as mock_st_up:
...
def mock_state_manager():
    with patch("src.web.ui.components.data_source_components.StateManager") as mock_sm_ds, \
         patch("src.web.ui.components.upload_components.StateManager") as mock_sm_up:
