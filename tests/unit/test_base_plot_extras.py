...
def test_render_advanced_options_shapes_edit_delete(mock_streamlit):
    ...
    config = {
        "shapes": [
            {"type": "line", "x0": 0, "y0": 0, "x1": 1, "y1": 1, "line": {"color": "red"}}
        ]
    }
    ...
    mock_streamlit.text_input.side_effect = ["new_x0", "new_y0", "new_x1", "new_y1", "0", "0", "1", "1"]
...
def test_render_reorderable_list(mock_streamlit):
    ...
    result_moved = plot.render_reorderable_list("List", items, "test")
