...
def test_persistent_legend_labels_per_column():
    ...
    plot = {"id": 1, "name": "Test Plot", "legend_mappings_by_column": {}}
    ...
    arch_labels = {"x86": "Intel x86-64", "arm": "ARM Cortex", "risc": "RISC-V"}
...
def test_legend_labels_backward_compatibility():
    ...
    plot = {
        "id": 1,
        "name": "Old Plot",
        "legend_mappings": {"baseline": "Baseline Config", "optimized": "Optimized Config"},
    }
...
def test_multiple_column_persistence():
    ...
    plot = {
        ...
        "legend_mappings_by_column": {
            "config": {"baseline": "Baseline", "opt1": "Optimization 1", "opt2": "Optimization 2"},
            "architecture": {"x86": "Intel", "arm": "ARM", "risc": "RISC-V"},
            "compiler": {"gcc": "GCC Compiler", "clang": "Clang/LLVM", "icc": "Intel Compiler"},
        },
    }
