...
Covers:
  - Typography inheritance chain (y2label→ylabel, yticks→ticks, legend2→legend)
...
class TestResolverImmutability:
    ...
    def test_input_preserved(self) -> None:
        ...
        original_legend2 = spec.typography.font_size_legend2
        original_secondary_font = spec.legends[1].font_size

        resolved = resolve_config(spec)

        # Original should be untouched
        assert spec.typography.font_size_legend2 == original_legend2
