...
class TestPortfolioFix:
    ...
    def test_show_portfolio_page_no_name_error(self, mock_api, mock_streamlit):
        ...
        """
        # Setup mocks
        mock_api.data_services.list_portfolios.return_value = ["p1"]
        mock_api.data_services.load_portfolio.return_value = {"some": "data"}
        ...
        mock_api.data_services.list_portfolios.assert_called()
