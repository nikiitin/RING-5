...
class TestStateManagement:
    ...
    def test_portfolio_save_and_load(
        ...
        plot_config = sample_workspace_data["plot_config"]
        ...
        pd.testing.assert_frame_equal(data.reset_index(drop=True), loaded_data.reset_index(drop=True))
