...
from src.parsing.impl.data_parser_perl.dataParserPerl import (  # noqa: E402
    DataParserPerl,
)
from src.parsing.params import DataParserParams  # noqa: E402
...
class TestParserFunctional:
    ...
    def test_parse_real_stats(self, test_data_path):
        ...
        with tempfile.TemporaryDirectory() as output_dir:
            ...
            parsings_config = [{"path": test_data_path, "files": "stats.txt", "vars": parser_vars}]
            ...
            with patch(
                "src.parsing.config_manager.ConfigurationManager.getParser"
            ) as mock_get_parser, patch(
                "src.parsing.config_manager.ConfigurationManager.getCompress"
            ) as mock_get_compress:
