...
For the *current*, genuinely-open (minor) issues, see the **Known issues** section of `/AGENTS.md` — it is
...
- Parsing/async issues → `/.agents/skills/parsing-and-variable-types/SKILL.md`.
- Rendering/figure styling → `/.agents/skills/rendering-figureconfig/SKILL.md`.
- Streamlit/UI/e2e → `/.agents/skills/e2e-streamlit-testing/SKILL.md` and `developer-guide/web/streamlit-best-practices.md`.
- Architecture map → `architecture/system-overview.md`, `architecture/layer-boundaries.md`, and `/AGENTS.md`.
