...
# RING-5 engineering reference

This section is a compact, code-oriented reference for maintainers. It complements the narrative
developer guide with catalogs, lookup tables, and task recipes.
...
This reference is maintained alongside the code. Repository contribution rules live in
[`AGENTS.md`](../../AGENTS.md), with focused task guides under `.agents/skills/`. When documentation
and implementation disagree, verify the behavior with tests and update the stale documentation.
