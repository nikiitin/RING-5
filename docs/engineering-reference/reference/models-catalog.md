...
- **Used by**: PlotlyFigureSpecBuilder, resolve_spec, FigureSpecToPlotly, FigureSpecToMatplotlib
...
- **Bold flags**: `bold_title` (False), `bold_xlabel` (False), `bold_ylabel` (False), `bold_y2label` (False), `bold_ticks` (False)
