...
[`AGENTS.md`](../../../AGENTS.md) is the authoritative short guide for automated and human
...
Task recipes under [`.agents/skills/`](../../../.agents/skills/) cover adding a plot, shaper, parser,
