...
**Save pipelines for reuse.** Once you have built a pipeline that produces the analysis you need, save it with a descriptive name. You can load saved pipelines on any plot to apply the same transformation sequence to different datasets.
