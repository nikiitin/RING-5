...
> suitable for direct inclusion in TeX documents. RING-5 also includes 13
> venue-specific presets (IEEE, ACM, ISCA, MICRO, and more) that automatically
> set dimensions, fonts, and DPI for common submission targets.
...
- **Publication Presets** -- Apply venue-specific formatting (IEEE, ACM, ISCA,
  MICRO, ASPLOS, HPCA, TACO, Nature, Science, poster, and slides) to produce
  camera-ready figures with a single click.
