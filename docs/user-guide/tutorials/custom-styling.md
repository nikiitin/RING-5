...
If you are targeting a specific conference, set the font sizes here to the values your venue requires, and set the figure width in the **Layout** pill (covered later) to the column width of your paper.
...
RING-5 uses automatic margin calculation by default. The margins adjust to fit your axis labels and legend without clipping. If you need manual control, set the margins explicitly in the Layout pill.
