...
| `font_size_legend3` | `-1` | `font_size_legend` |
| `legend3_number_fontsize` | `-1` | `font_size_legend3` (after resolution) |
| `legend3_text_fontsize` | `-1` | `font_size_legend3` (after resolution) |
...
| `number_fontsize` | `-1` | Own `font_size` (after resolution) |
| `text_fontsize` | `-1` | Own `font_size` (after resolution) |
...
font_size_legend (8)
    ...
    +-- font_size_legend3 (-1)  -> resolves to legend value
        +-- legend3_number_fontsize (-1)  -> resolves to legend3 (AFTER legend3 resolves)
        +-- legend3_text_fontsize (-1)    -> resolves to legend3 (AFTER legend3 resolves)
```

**Order matters**: `ticks -> yticks -> y2ticks` and `legend -> legend3 -> legend3_number/text`.
...
This ensures:
- Presets can set `-1` for secondary values and the inheritance "just works"
