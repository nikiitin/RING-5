...
[Optional] PresetApplicator.apply()    preset_applicator.py:42
       |
       v  FigureConfig (preset-merged)
...
| `PresetSpecBuilder.from_preset()` | `LaTeXPreset` dict | `FigureConfig` (publication settings) | `config_builder.py:201` |
