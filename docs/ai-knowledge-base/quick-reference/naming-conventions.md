...
|---|---|---|---|
| `font_size_*` | Typography per-element sizes (pts) | `src/core/models/visualization/typography_config.py` | `font_size_title`, `font_size_xlabel`, `font_size_ylabel`, `font_size_ticks`, `font_size_legend` |
| `bold_*` | Typography bold flags | `src/core/models/visualization/typography_config.py` | `bold_title`, `bold_xlabel`, `bold_ylabel`, `bold_y2label`, `bold_ticks` |
