...
- **ConfigSpecBuilder, PlotlyFigureSpecBuilder, PresetSpecBuilder**: `config_builder.py`
...
- **EngineManager**: `engine_manager.py` | **PresetApplicator**: `preset_applicator.py`
...
- **PresetManager**: `src/web/pages/ui/plotting/export/presets/preset_manager.py`
- **PresetSchema**: `src/web/pages/ui/plotting/export/presets/preset_schema.py`
- **PresetApplicator**: `src/web/rendering/preset_applicator.py`
- **PresetSpecBuilder**: `src/web/rendering/config_builder.py`
...
- **Presets**: `tests/unit/test_preset_applicator.py`
