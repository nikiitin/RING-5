...
from src.data_parser.src.impl.data_parser_perl.src.compressor.compressor import \
    Compressor
from src.data_parser.src.impl.data_parser_perl.src.parser_impl.perlParseWork import \
    PerlParseWork
from src.data_parser.src.impl.data_parser_perl.src.type_mapping.typeMapper import \
    TypeMapper
