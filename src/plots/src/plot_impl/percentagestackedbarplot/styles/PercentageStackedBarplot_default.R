source("src/plots/src/plot_impl/stackedbarplot/styles/StackedBarplot_default.R")
source("src/plots/src/plot_impl/percentagestackedbarplot/styles/info/percentageStackedBarplotInfo.R")
