...
class DataManagerR(DataManagerInterface):
    ...
    def _renameStats(self) -> None:
        ...
        RScriptCall = ["./src/data_management/src/impl/data_manager_R/dataRenamer.R"]
    ...
    def _mixStats(self) -> None:
        ...
        RScriptCall = ["./src/data_management/src/impl/data_manager_R/dataMixer.R"]
        RScriptCall.append(self._csvPath)
    ...
    def _reduceSeeds(self) -> None:
        ...
        RScriptCall = ["./src/data_management/src/impl/data_manager_R/reduceSeeds.R"]
        RScriptCall.append(self._csvPath)
        subprocess.call(RScriptCall)
    
    def _removeOutliers(self) -> None:
        print("Removing outliers")
        RScriptCall = ["./src/data_management/src/impl/data_manager_R/removeOutliers.R"]
        RScriptCall.append(self._csvPath)
    ...
    def _assignConfKeys(self) -> None:
        ...
        RScriptCall = ["./src/data_management/src/impl/data_manager_R/assignConfKeys.R"]
        RScriptCall.append(self._csvPath)
        subprocess.call(RScriptCall)
