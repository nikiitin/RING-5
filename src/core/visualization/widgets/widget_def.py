...
LAYOUT_MARGINS = WidgetSection(
    ...
    widgets=(
        ...
        NumberWidgetDef(
            key="margin_r", label="Right", default=100,
            min_value=0, max_value=1000, step=5,
            spec_path="dimensions.margins.right",
        ),
        NumberWidgetDef(
            key="margin_t", label="Top", default=80,
            min_value=0, max_value=1000, step=5,
            spec_path="dimensions.margins.top",
        ),
        NumberWidgetDef(
            key="margin_b", label="Bottom", default=120,
            min_value=0, max_value=1000, step=5,
            spec_path="dimensions.margins.bottom",
        ),
        NumberWidgetDef(
            key="margin_pad", label="Padding",
            default=0, min_value=0, max_value=200, step=1,
            spec_path="dimensions.margins.pad",
            help_text="Space between axis and labels",
        ),
        CheckboxWidgetDef(
            key="automargin", label="Auto-Margin (Prevents Cutoff)",
            default=True,
        ),
    ),
)
...
LAYOUT_DIMENSIONS = WidgetSection(
    ...
    widgets=(
        SliderWidgetDef(
            key="width", label="Width (px)", default=800,
            min_value=400, max_value=1600, step=50,
        ),
        SliderWidgetDef(
            key="height", label="Height (px)", default=500,
            min_value=300, max_value=1200, step=50,
        ),
    ),
)
...
TYPOGRAPHY = WidgetSection(
    ...
    widgets=(
        NumberWidgetDef(
            key="title_font_size", label="Plot Title Font Size", default=18,
            min_value=8, max_value=100, step=1,
            spec_path="typography.font_size_title",
        ),
        NumberWidgetDef(
            key="xaxis_title_font_size", label="X-Axis Title Font Size",
            default=14, min_value=8, max_value=100, step=1,
            spec_path="typography.font_size_xlabel",
        ),
        NumberWidgetDef(
            key="yaxis_title_font_size", label="Y-Axis Title Font Size",
            default=14, min_value=8, max_value=100, step=1,
            spec_path="typography.font_size_ylabel",
        ),
        SliderWidgetDef(
            key="yaxis_title_standoff", label="Y-Axis Title Standoff",
            default=0, min_value=0, max_value=100, step=1,
            help_text="Distance between Y-axis ticks and the title.",
        ),
        SliderWidgetDef(
            key="yaxis_title_vshift", label="Y-Axis Title Vertical Shift",
            default=0, min_value=-300, max_value=300, step=1,
            help_text="Move title up (+) or down (-) along the axis.",
        ),
        NumberWidgetDef(
            key="xaxis_tickfont_size", label="X-Axis Tick Size", default=12,
            min_value=8, max_value=100, step=1,
            spec_path="typography.font_size_ticks",
            help_text="Overwrites the basic X-axis font size in Advanced Options",
        ),
        ColorWidgetDef(
            key="xaxis_tickfont_color", label="X-Axis Tick Color",
            default="#444444",
        ),
        NumberWidgetDef(
            key="yaxis_tickfont_size", label="Y-Axis Tick Size", default=12,
            min_value=8, max_value=100, step=1,
            spec_path="typography.font_size_yticks",
        ),
        ColorWidgetDef(
            key="yaxis_tickfont_color", label="Y-Axis Tick Color",
            default="#444444",
        ),
    ),
)
...
LEGEND_POSITION = WidgetSection(
    ...
    widgets=(
        SelectWidgetDef(
            key="legend_orientation", label="Orientation", default="v",
            options=("v", "h"),
        ),
        NumberWidgetDef(
            key="legend_ncols", label="Columns", default=0,
            min_value=0, max_value=10, step=1,
            spec_path="legends.0.ncol",
            help_text="Number of legend columns. 0 = Auto (single column).",
        ),
        NumberWidgetDef(
            key="legend_col_width", label="Column Width (px)", default=150,
            min_value=0, max_value=500, step=5,
            help_text="Width of each legend column in pixels.",
        ),
        SelectWidgetDef(
            key="legend_valign", label="Vertical Align", default="middle",
...
LEGEND_APPEARANCE = WidgetSection(
    ...
    widgets=(
        CheckboxWidgetDef(
            key="transparent_legend", label="Transparent Background",
            default=False,
        ),
        ColorWidgetDef(
            key="legend_bgcolor", label="Background Color",
            default="#ffffff",
            spec_path="legends.0.bgcolor",
        ),
        ColorWidgetDef(
            key="legend_border_color", label="Border Color",
            default="#000000",
            spec_path="legends.0.border_color",
        ),
        NumberWidgetDef(
            key="legend_border_width", label="Border Width", default=0,
            min_value=0, max_value=5, step=1,
            spec_path="legends.0.border_width",
        ),
        ColorWidgetDef(
            key="legend_font_color", label="Text Color",
            default="#000000",
            spec_path="legends.0.font_color",
        ),
        NumberWidgetDef(
            key="legend_font_size", label="Font Size", default=12,
            min_value=8, max_value=100, step=1,
            spec_path="legends.0.font_size",
        ),
        ColorWidgetDef(
            key="legend_title_font_color", label="Title Color",
            default="#000000",
        ),
        NumberWidgetDef(
            key="legend_title_font_size", label="Title Size", default=14,
            min_value=8, max_value=100, step=1,
        ),
    ),
)
...
BACKGROUNDS = WidgetSection(
    ...
    widgets=(
        ...
        ColorWidgetDef(
            key="plot_bgcolor", label="Plot Background", default="#ffffff",
            spec_path="plot_bgcolor",
        ),
        ColorWidgetDef(
            key="paper_bgcolor", label="Paper (Outer) Background",
            default="#ffffff",
...
AXIS_COLORS = WidgetSection(
    ...
    widgets=(
        ColorWidgetDef(
            key="grid_color", label="Grid Color", default="#e5e5e5",
        ),
        ColorWidgetDef(
            key="axis_color", label="Axis Line/Tick Color", default="#444444",
        ),
    ),
)
...
DATA_LABELS = WidgetSection(
    ...
    widgets=(
        CheckboxWidgetDef(
            key="show_values", label="Show Values on Plot",
            default=False,
        ),
        SelectWidgetDef(
            key="text_color_mode", label="Value Color Mode",
            default="auto",
            options=("auto", "contrast", "custom"),
            help_text="Auto: theme default. Contrast: white on dark, black on light.",
        ),
        ColorWidgetDef(
            key="text_color", label="Value Color", default="#000000",
        ),
        NumberWidgetDef(
            key="text_font_size", label="Value Font Size", default=10,
            min_value=6, max_value=40, step=1,
        ),
        SliderWidgetDef(
            key="text_rotation", label="Value Rotation", default=0,
            min_value=-90, max_value=90, step=15,
        ),
        SelectWidgetDef(
            key="text_position", label="Value Position",
            default="auto",
            options=("auto", "inside", "outside"),
        ),
        SelectWidgetDef(
            key="text_anchor", label="Value Anchor",
            default="auto",
            options=("auto", "top", "middle", "bottom"),
        ),
        TextWidgetDef(
            key="text_format", label="Number Format (d3)",
            default=".2f",
            help_text="e.g. .2f for 2 decimals, .2s for SI suffix, .1% for percent.",
        ),
        SelectWidgetDef(
            key="text_display_logic", label="Display Logic",
            default="all",
            options=("all", "above_threshold", "below_threshold"),
        ),
        NumberWidgetDef(
            key="text_threshold", label="Threshold Value", default=0.0,
            as_int=False,
        ),
        SelectWidgetDef(
            key="text_constraint", label="Size Constraint",
            default="none",
            options=("none", "inside"),
