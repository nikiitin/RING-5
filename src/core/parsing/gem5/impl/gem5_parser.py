...
class Gem5Parser:
    ...
    def submit_parse_async(
        ...
        Gem5Parser._active_var_names = [v.name for v in processed_configs]
        Gem5Parser._last_batch_var_names = list(Gem5Parser._active_var_names)
    ...
    def get_last_batch_var_names() -> List[str]:
        ...
        concurrent batch.
        """
        return list(Gem5Parser._last_batch_var_names)
    ...
    def finalize_parsing(
        ...
        return Gem5Parser.construct_final_csv(
    ...
    def construct_final_csv(
        ...
        ordered_names = var_names or Gem5Parser._active_var_names
        # Fallback if empty
