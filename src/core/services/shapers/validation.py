...
_REQUIRED_PARAMS: dict[str, list[str]] = {
    ...
    "deriveColumn": ["dest", "op", "sources"],
    "groupCardinalitySelector": ["groupBy", "countColumn", "count"],
    "groupPredicateSelector": ["groupBy", "baselineColumn", "baselineValue", "predicateColumn"],
}
