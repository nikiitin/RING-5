...
class StyleManager:
    ...
    def render_style_ui(self, saved_config: Dict[str, Any], data: Optional[pd.DataFrame] = None, items: Optional[List[str]] = None, key_prefix: str = "") -> Dict[str, Any]:
        ...
        return self.ui_manager.render_style_ui(saved_config, data, items=items, key_prefix=key_prefix)

    def render_theme_options(self, saved_config: Dict[str, Any], data: Optional[pd.DataFrame] = None, items: Optional[List[str]] = None, key_prefix: str = "") -> Dict[str, Any]:
    ...
    def render_series_colors_ui(self, saved_config: Dict[str, Any], data: Optional[pd.DataFrame] = None, key_prefix: str = "") -> Dict[str, Any]:
        """Render series color UI."""
        return self.ui_manager.render_series_colors_ui(saved_config, data, key_prefix=key_prefix)

    def render_series_renaming_ui(self, saved_config: Dict[str, Any], data: Optional[pd.DataFrame] = None, items: Optional[List[str]] = None) -> Dict[str, Any]:
