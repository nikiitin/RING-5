---
name: debug-async-parsing
description: Debugging guide for async parsing workflows and concurrent.futures issues. Use when troubleshooting parsing failures, timeout errors, or async execution problems.
---
...
2. **Check Perl script execution**:
   ...
   perl src/parsing/gem5/perl/fileParser.pl \
...
- Work Pool Implementation: `src/parsing/workers/work_pool.py`
- Perl Parsers: `src/parsing/gem5/perl/`
