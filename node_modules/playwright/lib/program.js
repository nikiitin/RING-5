...
var import_program4 = require("./cli/daemon/program");
...
function addBrowserMCPServerCommand(program3) {
  ...
  (0, import_program3.decorateMCPCommand)(command, packageJSON.version);
}
function addBrowserCLIServerCommand(program3) {
  const command = program3.command("run-cli-server", { hidden: true });
  command.description("Interact with the browser over CLI");
  (0, import_program4.decorateCLICommand)(command, packageJSON.version);
}
...
addBrowserCLIServerCommand(import_program.program);
