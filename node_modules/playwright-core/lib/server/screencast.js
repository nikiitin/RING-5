...
class Screencast {
  ...
  _launchVideoRecorder(dir, size) {
    ...
    const outputFile = import_path.default.join(dir, this._videoId + ".webm");
    const videoOptions = {
      ...size,
      outputFile
    };
  ...
  async startExplicitVideoRecording(options = {}) {
    ...
    const size = (0, import_browserContext.validateVideoSize)(options.size, this._page.emulatedSize()?.viewport);
