...
class FFPage {
  constructor(session, browserContext, opener) {
    ...
    const promises = [];
    const videoOptions = this._page.isStorageStatePage ? void 0 : this._page.screencast.launchAutomaticVideoRecorder();
    if (videoOptions)
    ...
    this.addInitScript(new import_page.InitScript(""), UTILITY_WORLD_NAME).catch((e) => this._reportAsNew(e));
  }
  _reportAsNew(error) {
